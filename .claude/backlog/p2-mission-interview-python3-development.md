...
metadata:
  ...
  issue: '#547'
  last_synced: '2026-03-14T01:26:59Z'
---

## Story

As a **maintainer of the project infrastructure**, I want to **mission interview: python3-development** so that **the project infrastructure stays healthy**.

## Description

Interview the user with 5 mission statement questions to draft and refine `plugins/python3-development/mission.json`.
