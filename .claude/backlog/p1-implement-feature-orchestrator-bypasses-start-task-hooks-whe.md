...
|-------|---------|---------|
| Agent tool dispatch bypasses Skill/Agent tool hook chain entirely | VERIFIED | Hooks in skill frontmatter only fire in Skill tool invocation context; Agent tool bypasses this scope |
