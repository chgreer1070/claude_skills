...
metadata:
  ...
  issue: '#528'
  last_synced: '2026-03-21T08:08:08Z'
---

## Story

As a **maintainer of the project infrastructure**, I want to **mission interview: conventional-commits** so that **the project infrastructure stays healthy**.

## Description

Interview the user with 5 mission statement questions to draft and refine `plugins/conventional-commits/mission.json`.
