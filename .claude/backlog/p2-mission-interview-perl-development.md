...
metadata:
  ...
  issue: '#537'
  last_synced: '2026-03-21T03:45:42Z'
---

## Story

As a **maintainer of the project infrastructure**, I want to **mission interview: perl-development** so that **the project infrastructure stays healthy**.

## Description

Interview the user with 5 mission statement questions to draft and refine `plugins/perl-development/mission.json`.
