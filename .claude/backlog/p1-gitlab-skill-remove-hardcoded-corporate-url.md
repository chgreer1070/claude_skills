...
metadata:
  ...
  plan: ''
  issue: '#76'
  last_synced: '2026-03-03T03:54:16Z'
---

## Story

As a **developer using Claude Code skills**, I want to **`validate_glfm.py` lines 152-153 hardcode `https://sourcery.assaabloy.net` as the default gitlab instance url. `gitlab-ci-local-guide.md` line 51 also references this url. this leaks a corporate internal url into a public repository. replace with a generic placeholder (e.g., `https://gitlab.example.com`) or make the url a required argument with no default** so that **the tooling becomes more capable and complete**.
