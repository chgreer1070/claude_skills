...
metadata:
  ...
  source: 'GitHub Issue #526'
  added: '2026-03-22'
  priority: P2
  type: Chore
  status: needs-grooming
  issue: '#526'
  last_synced: '2026-03-22T15:09:47Z'
---

## Story

As a **maintainer of the project infrastructure**, I want to **mission interview: clang-format** so that **the project infrastructure stays healthy**.

## Description

Interview the user with 5 mission statement questions to draft and refine `plugins/clang-format/mission.json`.
