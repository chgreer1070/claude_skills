...
metadata:
  ...
  issue: '#527'
  last_synced: '2026-03-21T03:45:50Z'
---

## Story

As a **maintainer of the project infrastructure**, I want to **mission interview: commitlint** so that **the project infrastructure stays healthy**.

## Description

Interview the user with 5 mission statement questions to draft and refine `plugins/commitlint/mission.json`.
