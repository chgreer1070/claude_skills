...
metadata:
  ...
  issue: '#535'
  last_synced: '2026-03-21T03:45:43Z'
---

## Story

As a **maintainer of the project infrastructure**, I want to **mission interview: orchestrator-discipline** so that **the project infrastructure stays healthy**.

## Description

Interview the user with 5 mission statement questions to draft and refine `plugins/orchestrator-discipline/mission.json`.
