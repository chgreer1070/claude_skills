...
As a **maintainer of the project infrastructure**, I want to **mission interview: llamafile** so that **the project infrastructure stays healthy**.

## Description

Interview the user with 5 mission statement questions to draft and refine `plugins/llamafile/mission.json`.
