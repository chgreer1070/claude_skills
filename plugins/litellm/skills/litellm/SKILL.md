...
- **llamafile**: Activate the llamafile skill using `Skill(skill: "llamafile:llamafile")` for llamafile server setup, model management, and local LLM deployment patterns
- **uv**: Activate the uv skill using `Skill(skill: "uv:uv")` for Python project management, dependency handling, and virtual environment workflows
