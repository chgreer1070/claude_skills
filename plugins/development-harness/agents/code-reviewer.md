...
model: sonnet
tools: Read, Grep, Glob, Bash, mcp__plugin_dh_sam__sam_read, mcp__plugin_dh_backlog__artifact_register, mcp__plugin_dh_backlog__artifact_read
skills:
...
Read the SAM task file using `mcp__plugin_dh_sam__sam_read`. Extract:
