...
| sam-expert | `./methodology_development/` | (in-repo — no clone needed) |
...
- gastown-expert: `methodology_development/.meta/v1_comparisons/sam-vs-gastown.md` (accessed 2026-01-26)
...
- ralph-expert: `methodology_development/.meta/v1_comparisons/sam-vs-ralph-loop-orchestrator.md` (accessed 2026-01-26)
...
SAM (`./methodology_development/`) is part of this repository and is never cloned.
