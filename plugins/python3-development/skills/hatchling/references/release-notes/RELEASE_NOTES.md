...
Complete chronological documentation of notable changes to Hatchling formatted per [Keep a Changelog](https://keepachangelog.com/en/1.0.0/) with [Semantic Versioning](https://semver.org/spec/v2.0.0.html). Use this reference when helping users understand release history from v1.0 through the current release.

## Reference Information

Hatchling is a modern, extensible Python build backend implementing PEP 517 and PEP 660.
...
#### [1.27.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.27.0) - 2024-11-26
...
## Version History by Era

### Era 1: Recent Releases (v1.24-1.27)

#### [1.26.3](https://github.com/pypa/hatch/releases/tag/hatchling-v1.26.3) - 2024-11-12

**Fixed:**

- Support an old import path that is still used by some consumers like Hatch

#### [1.26.2](https://github.com/pypa/hatch/releases/tag/hatchling-v1.26.2) - 2024-11-12
...
#### [1.26.1](https://github.com/pypa/hatch/releases/tag/hatchling-v1.26.1) - 2024-11-10
...
#### [1.26.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.26.0) - 2024-11-10
...
- Properly ignore parent `.gitignore` files when the project root matches one of the patterns

#### [1.25.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.25.0) - 2024-06-22
...
#### [1.24.2](https://github.com/pypa/hatch/releases/tag/hatchling-v1.24.2) - 2024-04-22
...
#### [1.24.1](https://github.com/pypa/hatch/releases/tag/hatchling-v1.24.1) - 2024-04-18

**Fixed:**

- Maintain file permissions for `shared-scripts` option/`shared_scripts` build data of the `wheel` target

#### [1.24.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.24.0) - 2024-04-16
...
### Era 2: Major Features & Build Hooks (v1.20-1.23)

#### [1.23.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.23.0) - 2024-04-14
...
#### [1.22.5](https://github.com/pypa/hatch/releases/tag/hatchling-v1.22.5) - 2024-04-04

**Fixed:**

- Fix reading metadata from source distributions when fields are dynamic but not part of core metadata like entry points

#### [1.22.4](https://github.com/pypa/hatch/releases/tag/hatchling-v1.22.4) - 2024-03-23

**Fixed:**

- Only read source distribution metadata for fields that are explicitly defined as dynamic

#### [1.22.3](https://github.com/pypa/hatch/releases/tag/hatchling-v1.22.3) - 2024-03-19

**Fixed:**

- Fix the `custom` build hook when using dynamic dependencies

#### [1.22.2](https://github.com/pypa/hatch/releases/tag/hatchling-v1.22.2) - 2024-03-16
...
#### [1.22.1](https://github.com/pypa/hatch/releases/tag/hatchling-v1.22.1) - 2024-03-16

**Fixed:**

- Update the default version of core metadata to 2.3

#### [1.22.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.22.0) - 2024-03-16

**Metadata Hooks & Core Metadata 2.2**
...
#### [1.21.1](https://github.com/pypa/hatch/releases/tag/hatchling-v1.21.1) - 2024-01-25

**Fixed:**

- Fix loading of local plugins to account for newly released versions of a dependency

#### [1.21.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.21.0) - 2023-12-18
...
#### [1.20.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.20.0) - 2023-12-13
...
### Era 3: Python 3.12 Support & Build System Improvements (v1.15-1.19)

#### [1.19.1](https://github.com/pypa/hatch/releases/tag/hatchling-v1.19.1) - 2023-12-12
...
#### [1.19.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.19.0) - 2023-12-11
...
#### [1.18.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.18.0) - 2023-06-12

**Python 3.7 End of Support**
...
#### [1.17.1](https://github.com/pypa/hatch/releases/tag/hatchling-v1.17.1) - 2023-06-03
...
#### [1.17.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.17.0) - 2023-05-12

**Binary Build Target Enhancements**

**Added:**

- The `app` build target now embeds the project version in the name of binaries

#### [1.16.1](https://github.com/pypa/hatch/releases/tag/hatchling-v1.16.1) - 2023-05-11
...
#### [1.16.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.16.0) - 2023-05-11
...
#### [1.15.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.15.0) - 2023-05-09

**App/Binary Build Target Introduction**
...
### Era 4: Core Features & Major Enhancements (v1.4-1.14)

#### [1.14.1](https://github.com/pypa/hatch/releases/tag/hatchling-v1.14.1) - 2023-04-23
...
#### [1.14.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.14.0) - 2023-04-02
...
#### [1.13.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.13.0) - 2023-02-09

**Added:**

- Update the set of known trove classifiers to version 2023.2.8

#### [1.12.2](https://github.com/pypa/hatch/releases/tag/hatchling-v1.12.2) - 2023-01-05
...
#### [1.12.1](https://github.com/pypa/hatch/releases/tag/hatchling-v1.12.1) - 2022-12-31

**Fixed:**

- Fix minor regression in the PEP 517/660 function signatures that was discovered by Fedora

#### [1.12.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.12.0) - 2022-12-30

**Enhanced Type Hints & SPDX Updates**
...
#### [1.11.1](https://github.com/pypa/hatch/releases/tag/hatchling-v1.11.1) - 2022-10-19

**Fixed:**

- Fix default file selection behavior of the `wheel` target when there is a single top-level module

#### [1.11.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.11.0) - 2022-10-08

**Version Source Enhancements**
...
#### [1.10.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.10.0) - 2022-09-18
...
#### [1.9.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.9.0) - 2022-09-09

**Metadata Inspection & Pattern Matching**
...
#### [1.8.1](https://github.com/pypa/hatch/releases/tag/hatchling-v1.8.1) - 2022-08-25
...
#### [1.8.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.8.0) - 2022-08-16
...
#### [1.7.1](https://github.com/pypa/hatch/releases/tag/hatchling-v1.7.1) - 2022-08-13
...
#### [1.7.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.7.0) - 2022-08-12
...
#### [1.6.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.6.0) - 2022-07-23

**Version Source Refinements**
...
#### [1.5.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.5.0) - 2022-07-11

**PEP 639 & Build Options**
...
#### [1.4.1](https://github.com/pypa/hatch/releases/tag/hatchling-v1.4.1) - 2022-07-04
...
#### [1.4.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.4.0) - 2022-07-03

**Type Hinting & Build Hooks Introduction**
...
### Era 5: Initial Release & Foundation (v1.0-1.3)

#### [1.3.1](https://github.com/pypa/hatch/releases/tag/hatchling-v1.3.1) - 2022-06-22

**Fixed:**

- Improve error handling and CLI feedback

#### [1.3.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.3.0) - 2022-06-15

**Dynamic Metadata & Entry Points**

**Added:**

- Add `metadata` hook mechanism for dynamic metadata
- Improve dynamic field validation
- Update SPDX license information

#### [1.2.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.2.0) - 2022-05-20

**Version Sources & Wheel Improvements**

**Added:**

- Add `regex` version source
- Improve wheel target file selection
- Add better error messages

#### [1.1.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.1.0) - 2022-04-10

**Build Targets & Versioning**

**Added:**

- Add `sdist` and `wheel` build targets
- Implement version scheme support
- Add CLI commands for metadata inspection

#### [1.0.0](https://github.com/pypa/hatch/releases/tag/hatchling-v1.0.0) - 2022-03-28

**Initial Public Release**

Hatchling's first public release, introducing:

**Core Features:**

- Modern, standards-compliant Python build backend
- Implements PEP 517 (build system interface)
- Implements PEP 660 (editable installs)
- Support for wheel and source distribution building
- Built-in version source discovery
- Build hook extensibility
...
- **v1.5.0** (2022-07-11): Support for final draft of PEP 639
- **v1.9.0** (2022-09-09): Retroactive `License-File` support for core metadata v2.1
- **v1.12.0** (2022-12-30): Retroactive `License-Expression` support for core metadata v2.1
- **v1.26.0** (2024-11-10): Core metadata v2.4 support with updated `license-files` spec

### Metadata Hooks & Dynamic Metadata

- **v1.3.0** (2022-06-15): Initial metadata hook mechanism
- **v1.4.0** (2022-07-03): Version build hook introduction
- **v1.8.0** (2022-08-16): `get_known_classifiers` method for metadata hooks
- **v1.22.0** (2024-03-16): Metadata defaults to PKG-INFO; add hook dependencies method

### Version Sources & Enhancements

- **v1.2.0** (2022-05-20): Regex version source
- **v1.6.0** (2022-07-23): Code version source with extension module support
- **v1.11.0** (2022-10-08): Environment variable version source

### Build Hook Improvements

- **v1.4.0** (2022-07-03): Initial version build hook
- **v1.7.0** (2022-08-12): `require-runtime-features` option
- **v1.10.0** (2022-09-18): Improved dynamic metadata tracking
- **v1.22.0** (2024-03-16): Hook dependencies method

### Performance Optimizations

- **v1.4.0** (2022-07-03): Skip entering undesirable directories
- **v1.6.0** (2022-07-23): Improved directory traversal strategy
- **v1.9.0** (2022-09-09): Pattern matching closer to Git behavior

### Python 3.12 Support

- **v1.19.0** (2023-12-11): Official Python 3.12 support

### Recent Fixes & Polish

- **v1.25.0** (2024-06-22): Permission bit normalization
- **v1.26.0** (2024-11-10): Classifier verification environment variable
- **v1.27.0** (2024-11-26): Default core metadata version to 2.4
...
| ------- | ------------ | ------------------------- | ------ |
| 1.27.0  | 2024-11-26   | Core metadata 2.4 default | Stable |
| 1.26.0  | 2024-11-10   | PEP 639 full support      | Stable |
| 1.25.0  | 2024-06-22   | Permission normalization  | Stable |
| 1.24.0  | 2024-04-16   | Shared build artifacts    | Stable |
| 1.22.0  | 2024-03-16   | Metadata hooks enhanced   | Stable |
| 1.21.0  | 2023-12-18   | Path context modifiers    | Stable |
| 1.19.0  | 2023-12-11   | Python 3.12 support       | Stable |
| 1.18.0  | 2023-06-12   | Drop Python 3.7           | Stable |
| 1.15.0  | 2023-05-09   | App build target          | Stable |
| 1.12.0  | 2022-12-30   | Type hints & SPDX         | Stable |
| 1.11.0  | 2022-10-08   | Env version source        | Stable |
| 1.9.0   | 2022-09-09   | Metadata inspection       | Stable |
| 1.8.0   | 2022-08-16   | Metadata hook methods     | Stable |
| 1.5.0   | 2022-07-11   | PEP 639 support           | Stable |
| 1.4.0   | 2022-07-03   | Build hooks & type hints  | Stable |
| 1.0.0   | 2022-03-28   | Initial release           | Stable |
...
- **Next major version**: Drop support for Python 3.8
- **Future**: Removal of `app` build target (use `binary` instead)
- **Future**: Removal of `macos-max-compat` option (disabled by default as of v1.25.0)

### Past Deprecations

- **v1.22.0**: `app` build target renamed to `binary` (old name still works)
- **v1.18.0**: Python 3.7 support dropped

---

## Related Documentation

- [Hatchling GitHub Repository](https://github.com/pypa/hatch)
- [Hatchling Official Documentation](https://hatch.pypa.io/)
- [GitHub Release Tags](https://github.com/pypa/hatch/releases)
