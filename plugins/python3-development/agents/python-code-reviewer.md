...
whenToUse: |
  ...
  user: "Review the code quality in src/auth.py"
  assistant: "I'll use python-code-reviewer to analyze for code smells and modernization opportunities."
  </example>
  <example>
  Context: User is refactoring a module.
  user: "I'm refactoring the database module, can you review it?"
  assistant: "I'll use python-code-reviewer to check for quality issues and best practices."
  </example>
  <example>
  Context: User needs to identify performance issues.
  user: "Find performance bottlenecks in our API handlers"
  assistant: "I'll use python-code-reviewer to analyze the code for performance anti-patterns."
  </example>
---
